...
if __name__ == "__main__":
    ...
    servico1 = Servico("Vacinação", 150)
    petshop.cadastrar_servico(servico1.nome, servico1.preco)

    # Listar serviços cadastrados
    print("Serviços disponíveis:", petshop.listar_servicos())

   # Testando o cadastro de consultas
    consulta1 = petshop.cadastrar_consulta("05/10/2024", "14:00", "Consulta de rotina", servico1, animal1)
